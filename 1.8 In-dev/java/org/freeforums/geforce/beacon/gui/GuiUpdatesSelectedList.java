...
public class GuiUpdatesSelectedList extends GuiListExtended{
	
	private List list;

	public GuiUpdatesSelectedList(Minecraft mc, int par2, int par3, List par5List) {
    ...
    {
        String s = EnumChatFormatting.UNDERLINE + "" + EnumChatFormatting.BOLD + "Selected mod updates";
