...
public class mod_Beacon {
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		String tempMcDirectory = mod_Beacon.configFile.getString("HDD path", "options", "C:", "What hard drive is Minecraft located on?");
		if(!tempMcDirectory.endsWith(":")){ 
			mcDirectory = "C:";
		}else{
