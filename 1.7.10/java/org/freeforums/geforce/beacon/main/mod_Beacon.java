...
@Mod(modid="beacon", name="Beacon", version=mod_Beacon.VERSION, guiFactory = "org.freeforums.geforce.beacon.gui.BeaconGuiFactory")
public class mod_Beacon {
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		mcDirectory = mod_Beacon.configFile.getString(".minecraft folder path", "options", "*default*", "What is the path to your .minecraft folder?");		
